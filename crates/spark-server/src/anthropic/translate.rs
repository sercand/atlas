...
/// Serialize the canonical [`crate::ir::ChatResponse`] into Anthropic's
/// `MessagesResponse` wire shape (non-streaming). Reads the first
/// choice — the Anthropic adapter pins `n = 1`.
pub(super) fn ir_to_anthropic_response(ir: crate::ir::ChatResponse) -> MessagesResponse {
